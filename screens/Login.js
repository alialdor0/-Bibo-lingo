...
const s = StyleSheet.create({
  ...
  bird:      { width: 88, height: 88, borderRadius: 44, borderWidth: 2, borderColor: 'rgba(46,139,87,0.55)', backgroundColor: '#0a150a', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
